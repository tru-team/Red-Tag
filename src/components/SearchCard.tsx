        ...
        <div className="flex border-b border-gray-100 px-2 md:px-4 overflow-x-auto">
          {TABS.map((tab) => (
            <button
              ...
              className={`flex items-center gap-1.5 px-0 mx-3 py-3.5 text-[14px]  font-medium whitespace-nowrap border-b-2 transition-colors ${
                activeTab === tab.label
        ...
        <div className="p-4 md:p-5 space-y-3">
          ...
          <div className="w-full flex items-center gap-3 mt-2">
            <div className="w-full flex items-center rounded-[40px] py-2 pl-3 pr-1.5 border border-[#ddd]">
              <button className="h-[30px] flex mr-2 items-center gap-1.5 text-xs text-black font-semibold shrink-0 bg-[#F0F1F1] rounded-3xl px-4 py-0 animate-pulse">
