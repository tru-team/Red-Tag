        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 bg-[#80C600] rounded-full animate-pulse" />
          ...
          <div className="p-5 space-y-4 min-h-[300px]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <span className="w-5 h-5 bg-red-600 rounded-full flex items-center justify-center animate-pulse">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
          ...
          <div className="border-t border-gray-100 px-5 py-3 flex items-center gap-3">
            ...
            <button className="flex mr-2 items-center gap-1.5 text-xs text-gray-500 font-medium shrink-0 bg-[#F0F1F1] rounded-3xl px-3 py-1 animate-pulse">
            ...
            <button className="w-8 h-8 bg-[#CA2129] hover:bg-red-700 rounded-full flex items-center justify-center transition-colors shrink-0 animate-bounce">
